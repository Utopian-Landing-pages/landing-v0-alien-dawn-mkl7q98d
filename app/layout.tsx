...
export const metadata: Metadata = {
  title: 'Alien Dawn - Fight the aliens. Confront your demons.',
  description: 'A realistic, modern-day platformer with compelling characters, morally gray aspects, diverse backstories, and unique personalities that affect gameplay.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
...
export default function RootLayout({
  ...
  var TOKEN="862a4dfe-f3af-4f90-be4b-0d033f4caed855648e340d7d54226e2e6919b2f71526";
